  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="h-12 w-12 rounded-full border-2 border-stroke">
          <img
      ...
      <div
        ...
        className={`absolute right-0 mt-4 flex w-62.5 text-xs flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark ${
