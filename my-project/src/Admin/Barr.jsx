...
const Barr = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={` fixed left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden  bg-[#fff] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
        sidebarOpen ? "translate-x-0" : "-translate-x-full overflow-y-auto"
      }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium  duration-300 ease-in-out text-black dark:text-white hover:text-[#4B1DA1] hover:bg-[#E8E1F3] dark:hover:bg-meta-4 ${
                          (pathname === "/" ||
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium font-inter text-black dark:text-white hover:text-[#4B1DA1] duration-300 ease-in-out hover:bg-[#E8E1F3] dark:hover:bg-meta-4 ${
                          (pathname === "/account" ||
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li className="text-black dark:text-white">
                <div
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black dark:text-white hover:text-[#34a49f] hover:bg-[#E8E1F3] duration-300 ease-in-out dark:hover:bg-meta-4 ${
                    pathname.includes("chart") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
